...
const res_cep = 'resultado_cep'; //saida dos resultados do CEP - [EXEMPLO]
//------- CARREGA -----
window.onload = function () {
  if (
    document.getElementById(estado_box) &&
    document.getElementById(cidade_box)
  ) {
    //estados
    for (var est in estados) {
      document.getElementById(estado_box).innerHTML +=
        '<option value="' +
        estados[est][1] +
        '">' +
        estados[est][0] +
        '</option>';
      /*[ EXEMPLOS ]*/
      document.getElementById('estado_sb2').innerHTML +=
        '<option value="' +
        estados[est][1] +
        '">' +
        estados[est][0] +
        '</option>';
      document.getElementById('estado_sb3').innerHTML +=
        '<option value="' +
        estados[est][1] +
        '">' +
        estados[est][0] +
    ...
    //cidades
    document.getElementById(cidade_box).innerHTML +=
      '<option value="' + cidades[0][1] + '">' + cidades[0][0] + '</option>';
    /*[ EXEMPLOS ]*/
    document.getElementById('cidades_sb2').innerHTML +=
      '<option value="' + cidades[0][1] + '">' + cidades[0][0] + '</option>';
    /*[ FIM EXEMPLOS ]*/
    //log
    ...
    console.error(
      'STATUS [ERRO: Houve um erro ao carregar as SelectBoxes, verifique o ID das mesmas]'
    );
  }
};
//------- SELECIONA ---
function muda_estado() {
  ...
  document.getElementById(ibge_estado_inp).value =
    estados[estado_selecionado][2]; //Códigos do IBGE - Estado
  document.getElementById(ibge_cidade_inp).value =
    cod_ibge_cidades[estado_selecionado][cidade_selecionada]; //Códigos do IBGE - Cidades
  //cidades
  ...
  for (var iata in cod_iata[estado_selecionado]) {
    ...
    iat.text =
      cod_iata[estado_selecionado][iata][1] +
      ' - ' +
      cod_iata[estado_selecionado][iata][2];
    iat.value = cod_iata[estado_selecionado][iata][2];
    document.getElementById(iata_aeroportos).appendChild(iat);
  }
  /*[ EXEMPLOS ]*/
  let estado_selecionado2 = document.getElementById('estado_sb2').selectedIndex;
  let cidade_selecionada2 = document.getElementById('estado_sb2').selectedIndex;
  for (var cid2 in cidades[estado_selecionado2]) {
    let c2 = document.createElement('option');
    c2.text = cidades[estado_selecionado2][cid2];
    c2.value = cidades[estado_selecionado2][cid2];
    document.getElementById('cidades_sb2').appendChild(c2);
  }
  /*[ FIM EXEMPLOS ]*/
}
function muda_cidade() {
  ...
  for (var iata in cod_iata[estado_selecionado]) {
    ...
    iat.value = cod_iata[estado_selecionado][iata][2];
    if (
      cod_iata[estado_selecionado][iata][0] ==
      document.getElementById(cidade_box).value
    ) {
...
function buscaDadosCEP() {
  ...
  request.open(
    'GET',
    'https://viacep.com.br/ws/' + codpostal_input.value + '/json/',
    true
  );
  ...
  request.onloadend = function () {
    ...
    //outros dados do CEP [EXEMPLO]
    document.getElementById(res_cep).style.display = 'block';
    document.getElementById(res_cep).innerHTML =
      '<b>[ENDEREÇO:</b> ' +
      retorno.logradouro +
      '<b>] - [BAIRRO:</b> ' +
      retorno.bairro +
...
var estados = [
  ...
  ['Bahia', 'BA', '29'], //ok
  ['Ceará', 'CE', '23'], //ok
  ['Distrito Federal', 'DF', '53'], //ok
  ['Espírito Santo', 'ES', '32'], //ok
  ['Goiás', 'GO', '52'], //ok
  ['Maranhão', 'MA', '21'], //ok
  ['Mato Grosso', 'MT', '51'], //ok
  ['Mato Grosso do Sul', 'MS', '50'], //ok
  ['Minas Gerais', 'MG', '31'], //ok
  ['Pará', 'PA', '15'], //ok
  ['Paraíba', 'PB', '25'], //ok
  ['Paraná', 'PR', '41'], //ok
  ['Pernambuco', 'PE', '26'], //ok
  ['Piauí', 'PI', '22'], //ok
  ['Rio Grande do Norte', 'RN', '24'], //ok
  ['Rio Grande do Sul', 'RS', '43'], //ok
  ['Rio de Janeiro', 'RJ', '33'], //ok
  ['Rondônia', 'RO', '11'], //ok
  ['Roraima', 'RR', '14'], //ok
  ['Santa Catarina', 'SC', '42'], //ok
  ['São Paulo', 'SP', '35'], //ok
  ['Sergipe', 'SE', '28'], //ok
  ['Tocantins', 'TO', '17'],
]; //ok
...
var cod_iata = /*0.Aviso*/ [
  ...
  /*1.Acre*/ [
    ...
    ['Cruzeiro do Sul', 'Aeroporto Internacional de Cruzeiro do Sul', 'CZS'],
  ],
  ...
  /*5.Bahia*/ [
    ['Salvador', 'Aeroporto Internacional de Salvador', 'SSA'],
    ['Porto Seguro', 'Aeroporto Internacional de Porto Seguro', 'BPS'],
    ['Ilhéus', 'Aeroporto de Ilhéus', 'IOS'],
  ],
  /*6.Ceará*/ [
    ['Fortaleza', 'Aeroporto Internacional de Fortaleza', 'FOR'],
    ['Juazeiro do Norte', 'Aeroporto de Juazeiro do Norte', 'JDO'],
  ],
  ...
  /*10.Maranhão*/ [
    ['São Luis', 'Aeroporto Internacional de São Luís', 'SLZ'],
    ['Imperatriz', 'Aeroporto de Imperatriz', 'IMP'],
  ],
  ...
  /*13.M. Gerais*/ [
    ['Uberlândia', 'Aeroporto de Uberlândia', 'UDI'],
    ['Confins', 'Aeroporto Internacional de Minas Gerais', 'CNF'],
    ['Montes Claros', 'Aeroporto de Montes Claros', 'MOC'],
  ],
  /*14.Pará*/ [
    ['Belém', 'Aeroporto Internacional de Belém', 'BEL'],
    ['Santarém', 'Aeroporto de Santarém', 'STM'],
    ['Marabá', 'Aeroporto de Marabá', 'MAB'],
  ],
  /*15.Paraíba*/ [
    ['João Pessoa', 'Aeroporto Internacional de João Pessoa', 'JPA'],
    ['Campina Grande', 'Aeroporto de Campina Grande', 'CPV'],
  ],
  /*16.Paraná*/ [
    ['Curitiba', 'Aeroporto Internacional de Curitiba', 'CWB'],
    ['Maringá', 'Aeroporto Regional de Maringá', 'MGF'],
    ['Londrina', 'Aeroporto de Londrina', 'LDB'],
    ['Foz do Iguaçu', 'Aeroporto Internacional de Foz do Iguaçu', 'IGU'],
  ],
  /*17.Pernambuco*/ [
    ['Recife', 'Aeroporto Internacional do Recife', 'REC'],
    ['Petrolina', 'Aeroporto de Petrolina', 'PNZ'],
  ...
  /*20.R.G Sul*/ [
    ['Porto Alegre', 'Aeroporto Internacional de Porto Alegre', 'POA'],
    ['Caxias do Sul', 'Aeroporto Regional de Caxias do Sul', 'CXJ'],
  ],
  /*21.R. Janeiro*/ [
    ['Ilha do Governador', 'Aeroporto Internacional do Rio de Janeiro', 'GIG'],
    ['Rio de Janeiro', 'Aerorporto Santos Dumont', 'SDU'],
    ['Cabo Frio', 'Aeroporto Internacional de Cabo Frio', 'CFB'],
  ],
  /*22.Rondônia*/ [
  ...
  /*24.St. Catarina*/ [
    ['Florianópolis', 'Aeroporto Internacional de Florianópolis', 'FLN'],
    ['Navegantes', 'Aeroporto Internacional de Navegantes', 'NVT'],
    ['Joinville', 'Aeroporto de Joinville', 'JOI'],
    ['Chapecó', 'Aeroporto de Chapecó', 'XAP'],
  ],
  /*25.São Paulo*/ [
    ['São Paulo', 'Aeroporto Internacional de São Paulo', 'CGH'],
    ['Campinas', 'Aeroporto Internacional de Viracopos', 'VCP'],
    ['Guarulhos', 'Aeroporto Internacional de Guarulhos', 'GRU'],
    ['Presidente Prudente', 'Aeroporto Estadual de Presidente Prudente', 'PPB'],
    ['Bauru', 'Aeroporto Estadual de Bauru', 'JTC'],
  ],
